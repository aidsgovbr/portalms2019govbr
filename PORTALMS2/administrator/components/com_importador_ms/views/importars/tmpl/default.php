...
$canOrder	= $user->authorise('core.edit.state', 'com_importador_ms');
$saveOrder	= $listOrder == 'a.ordering';
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_importador_ms&task=importars.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'importarList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="importarList">
			<thead>
                ...
                <?php endif; ?>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'Criado por', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
