 ...
 * ms Table class
 */
class Arquivos_msTablems extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__arquivos_ms_tipo', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
        ...
        if(!JFactory::getUser()->authorise('core.admin', 'com_arquivos_ms.ms.'.$array['id'])){
            $actions = JFactory::getACL()->getActions('com_arquivos_ms','ms');
            $default_actions = JFactory::getACL()->getAssetRules('com_arquivos_ms.ms.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_arquivos_ms.ms.' . (int) $this->$k;
    }
