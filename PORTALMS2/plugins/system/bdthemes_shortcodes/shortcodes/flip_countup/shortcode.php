...
class Su_Shortcode_flip_countup extends Su_Shortcodes {

    function __construct() {
        parent::__construct();
    }

    public static function flip_countup($atts = null, $content = null) {
        $atts = su_shortcode_atts(array(
            'datetime'      => '2017-03-27T14:15:00', // example: 2017-03-27T14:15:00
        ...
        $settings ='
            <script>
                ...
                function '.$id.'Init(tick) {
                    ...
                    var counter = Tick.count.up(nextYear);
        ...
        suAsset::addFile('css', 'flip-countup.css', __FUNCTION__);
