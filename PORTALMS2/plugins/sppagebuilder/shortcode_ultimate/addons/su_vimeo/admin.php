...
if (class_exists('Su_Shortcode_vimeo')) {
    SpAddonsConfig::addonConfig(
    	array(
            'type'       => 'single',
            'category'   => 'Shortcode Ultimate',
            'addon_name' => 'su_vimeo',
            'title'      => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_VIMEO'),
            'desc'       => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_VIMEO_DESC'),
            'icon'       => JURI::root().'plugins/sppagebuilder/shortcode_ultimate/addons/su_vimeo/element.svg',
    		...
    		'attr'=>array(
    			'general' => array(
                    ...
                    'loop' => array(
                        'type'  => 'checkbox',
                        'std'   => '0',
                        'title' => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_VIMEO_LOOP'),
                        'desc'  => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_VIMEO_LOOP_DESC')
                    ),
                    'class' => array(
                        'type'  => 'text',
