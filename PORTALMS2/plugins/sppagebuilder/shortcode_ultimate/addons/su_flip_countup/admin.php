...
if (class_exists('Su_Shortcode_flip_countup')) {
	SpAddonsConfig::addonConfig(
		array(
			'type'       => 'wrap',
			'category'   => 'Shortcode Ultimate',
			'addon_name' => 'su_flip_countup',
			'title'      => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_FLIP_COUNTUP'),
			'desc'       => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_FLIP_COUNTUP_DESC'),
	        'icon'       => JURI::root().'plugins/sppagebuilder/shortcode_ultimate/addons/su_flip_countup/element.svg',

			'attr'       => array(
				'general'    => array(
					'datetime' => array(
						'type'  => 'text',
						'std'   => '2017-03-27T14:15:00',
						'title' => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_DATETIME'),
						'desc'  => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_FCU_DATETIME_DESC'),
	                ),
	                'time_name' => array(
						'type'  => 'checkbox',
						'std'   => '1',
