...
<div class="borderHeading" style="font-size: 1.05em; color: #1e68d0;">
		...
		<div id="myModal<?php echo $key ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		  ...
		  <div class="modal-body row-fluid">
		    <div class="span12">
		    	...
		    	?>
		    	<p>
		    		<?php if ($value['LATITUDE'] != NULL && $value['LONGITUDE'] != NULL){ ?>
		    		<a class="googlemaps" href="https://www.google.com.br/maps/place/<?php echo $value['LATITUDE'].','.$value['LONGITUDE']; ?>" target="_blank">Google Maps</a>
		    		<?php } else{ ?>
