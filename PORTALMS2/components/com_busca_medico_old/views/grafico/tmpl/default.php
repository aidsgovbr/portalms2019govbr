		...
		<div class="span12" style="min-height: 0;">
			...
			<div id="myModal<?php echo $key ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="modal-body row-fluid">
					...
					<p><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d122864.47790001593!2d-47.91229528892665!3d-15.77677940310968!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x935a3b3bc8733b11%3A0x209997bee1ad8b0d!2zTWluaXN0w6lyaW8gZGEgU2HDumRl!5e0!3m2!1spt-BR!2sbr!4v1424694971041" width="400" height="300" frameborder="0" style="border:0"></iframe></p>
				</div>
...
<script type="text/javascript" charset="utf-8" async defer>
 jQuery("#grafico").load("resultado.php?nu=<?php echo $_GET['nu']; ?>");
 
// Outputs: bar!, fn2 says: bar!
callbacks.fire( "bar!" );
var jqxhr = jQuery.ajax( "resultado" )
  .done(function() {
...
jqxhr.always(function() {
  ...
  <?php //include(Busca_medicoViewResultado::grafico()); ?>
});

// jQuery( window ).ready(function() {
// 	jQuery('#grafico').display('none');
// });
jQuery( window ).load(function() {
	<?php //Busca_medicoViewResultado::grafico(); ?>
});
</script>
	...
	function drawChart() {
		...
		var data = google.visualization.arrayToDataTable([
			['Tipo', 'Qtd'],
			['Normal', <?php echo $this->parto_normal[0]['QTD_PARTO_NORMAL']; ?>],
			['Cesária', <?php echo $this->parto_cesaria[0]['QTD_PARTO_CESARIA']; ?>]
			]);
	...
	function drawVisualization() {
				  ...
				  var data = google.visualization.arrayToDataTable([
				  	['Ano', 'Normal', 'Cesária'],
				  	['2012',  <?php echo $this->parto_ano[0]['N2012']; ?>,      <?php echo $this->parto_ano[0]['C2012']; ?>,],
				  	['2013',  <?php echo $this->parto_ano[0]['N2013']; ?>,      <?php echo $this->parto_ano[0]['C2013']; ?>],
				  	['2014',  <?php echo $this->parto_ano[0]['N2014']; ?>,      <?php echo $this->parto_ano[0]['C2014']; ?>],
				  	]);
