 ...
 * @since       1.5
 */
class SearchModelQuero extends SearchModelSearch
{
	/**
	 * Search data array
	 *
	...
	public function getData()
	{
		...
		if (empty($this->_data))
		{
			...
			$results = $dispatcher->trigger('onContentSearchQueroSaber', array(
	...
	public function getAreas()
	{
		...
		if (empty($this->_areas['search']))
		{
			...
			JPluginHelper::importPlugin('search');
			$dispatcher = JEventDispatcher::getInstance();
			$searchareas = $dispatcher->trigger('onContentSearchAreasQueroSaber');
