 ...
 * @subpackage  com_content
 */
class ContentModelFeaturedms extends ContentModelArticles
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery($resolveFKs = true)
	{
		...
		// Implement Category Level Access
		$user		= JFactory::getUser();
		if (!$user->authorise('core.admin'))
		{
			JLoader::register('OverrideHelper', JPATH_ADMINISTRATOR . '/components/com_categories/helpers/override.php');
			$authorised = OverrideHelper::getAuthorisedCategories('com_content', 'core.edit');
			if ($authorised)
			{
				$categories	= implode(',', $authorised);
