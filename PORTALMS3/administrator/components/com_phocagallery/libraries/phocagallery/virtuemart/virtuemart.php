...
class PhocaGalleryVirtueMart
{
	public static function getVmLink($id, &$errorMsg) {
		...
		if (is_file( JPATH_ADMINISTRATOR . DS . 'components' . DS . 'com_virtuemart/helpers/config.php')) {
			 require_once( JPATH_ADMINISTRATOR . DS . 'components' . DS . 'com_virtuemart/helpers/config.php' );
