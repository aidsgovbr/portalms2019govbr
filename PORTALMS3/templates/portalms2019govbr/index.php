...
<?php //var_dump($view); ?>
<div id="interna"> 
  <!-- <div id="<?php echo $view != "default" || $active_item->home == '0' ? 'conteudo-interna' : 'pginicial' ?>"> --> 
    ...
    <nav class="menu-principal">
      <div class="container">
        <div class="header-wrapper"> 
          ...
          <div id="logo" class="span8<?php if($this->params->get('classe_nome_principal', '') != '') echo ' '.$this->params->get('classe_nome_principal'); ?>"> <a href="<?php echo JURI::root(); ?>" title="<?php echo $this->params->get('nome_principal', 'Nome principal'); ?>">
...
<div class="voltar-topo">
    <a href="#interna">Voltar ao topo</a>
</div>
