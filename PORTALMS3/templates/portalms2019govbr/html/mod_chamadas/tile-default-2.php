...
<div class="row">
   <div class="tile tile-default ">
      ...
      <div class="nitf-basic-tile tile-content column">
         <img src="<?php echo $lista->image_url ?>" width="370" height="246" class="
		 " alt="<?php echo $lista->image_alt ?>" title="<?php echo $lista->title ?>" />
