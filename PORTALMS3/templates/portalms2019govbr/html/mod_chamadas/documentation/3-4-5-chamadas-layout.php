      ...
      <div class="foto-sobreposta-pequena tile-default">
         <?php
            foreach ($lista_chamadas as $key => $value){
            	...
            	if ($key == 0) { ?>
         <div class="column col-md-3" data-panel="one">
         ...
         <?php } elseif ($key == 1) { ?>
         <div class="column col-md-4" data-panel="two">
            <div class="tile foto-sobreposta-pequena foto-sobreposta">
               <div class="nitf-basic-tile tile-content">
                  <p class="subtitle">
                     <?php echo $value->chapeu; ?>
            ...
            <div class="column col-md-5" data-panel="three">
               <div class="tile foto-sobreposta-pequena foto-sobreposta">
                  <div class="nitf-basic-tile tile-content">
                     <p class="subtitle">
                        <?php echo $value->chapeu; ?>
         ...
         <?php 
            ...
            ?>
				...
				<?php if ($params->get('texto_saiba_mais')): ?><div class="botoes-centro">
