...
if (class_exists('Su_Shortcode_spoiler')) {
    SpAddonsConfig::addonConfig(
    	array(
            'type'       => 'wrap',
            'category'   => 'Shortcode Ultimate',
            'addon_name' => 'su_spoiler',
            'title'      => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SPOILER'),
            'desc'       => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SPOILER_DESC'),
            'icon'       => JURI::root().'plugins/sppagebuilder/shortcode_ultimate/addons/su_spoiler/element.svg',
