...
if (class_exists('Su_Shortcode_post_grid')) {
    SpAddonsConfig::addonConfig(
    	array(
    		'type'       => 'single',
    		'category'   => 'Shortcode Ultimate',
    		'addon_name' => 'su_post_grid',
    		'title'      => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POST_GRID'),
    		'desc'       => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POST_GRID_DESC'),
            'icon'       => JURI::root().'plugins/sppagebuilder/shortcode_ultimate/addons/su_post_grid/element.svg',
    		...
    		'attr'=>array(
    			'general' => array(
                    ...
                    'show_search' => array(
                        'type'  => 'checkbox',
                        'std'   => '0',
                        'title' => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOW_SEARCH'),
                    ...
                    'show_thumb' => array(
                        ...
                        'std'   => '1',
                        'title' => 'Show Thumb', 
                        'desc'  => 'You can set your image show/hide from here.',
                    ),
                    'thumb_height' => array(
                        'type'    => 'number',
                        'std'     => 320,
                    ...
                    'show_category' => array(
                        'type'  => 'checkbox',
                        'std'   => '1',
                        'title' => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_CATEGORY_SHOW'),
