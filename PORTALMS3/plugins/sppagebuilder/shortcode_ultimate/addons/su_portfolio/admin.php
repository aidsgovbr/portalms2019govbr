...
if (class_exists('Su_Shortcode_portfolio')) {
	SpAddonsConfig::addonConfig(
		array(
			'type'       => 'single',
			'category'   => 'Shortcode Ultimate',
			'addon_name' => 'su_portfolio',
			'title'      => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_PORTFOLIO'),
			'desc'       => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_PORTFOLIO_DESC'),
	        'icon'       => JURI::root().'plugins/sppagebuilder/shortcode_ultimate/addons/su_portfolio/element.svg',
			...
			'attr'=>array(
				'general' => array(
	                ...
	                'show_link' => array(
						'type'  => 'checkbox',
						'std'   => '1',
						'title' => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOW_LINK'),
						'desc'  => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOW_LINK_DESC'),
	                ),
	                'show_zoom' => array(
						'type'  => 'checkbox',
						'std'   => '1',
						'title' => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOW_ZOOM'),
