...
class Su_Shortcode_flip_back_config extends Su_Data{
    ...
    static function get_config() {
        ...
        return array(
            'name'     => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_FLIP_BACK'),
            'type'     => 'wrap',
            'group'    => 'extra content',
            'desc'     => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_FLIP_BACK_DESC'),
            'icon'     => 'file',
            'atts'     => array(
                'background' => array(
                    'type'    => 'color',
            ...
            'content'  => sprintf( "Flip Back Box Content")
        );
    }
